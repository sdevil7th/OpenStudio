...
export function MixerPanel({
  ...
  useEffect(() => {
    const handleCatalogChanged = () => {
      if (showMonitorPluginPicker) {
        void refreshAvailableMonitorPlugins();
      }
    };
  ...
  }, [refreshAvailableMonitorPlugins, showMonitorPluginPicker]);
  ...
  const masterTrack: Track = {
    ...
    clipping: false,
    automationLanes: masterAutomationLanes,
    showAutomation: showMasterAutomation,
    automationReadEnabled: masterAutomationReadEnabled,
    automationWriteEnabled: masterAutomationWriteEnabled,
    automationEnabled: masterAutomationReadEnabled,
            ...
            <div className="border-t border-amber-700/30 bg-neutral-900 flex flex-col max-h-45">
              ...
              <div className="flex-1 overflow-y-auto px-1 pb-1 space-y-px">
                {filteredMonitorPlugins.length === 0 ? (
                  ...
                  filteredMonitorPlugins.map((plugin) => (
                    <button
