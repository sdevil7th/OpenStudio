...
/**
 * OpenStudioScriptWindow — Native JUCE window for Lua script GUIs.
 *
 ...
 */
class OpenStudioScriptWindow : public juce::DocumentWindow, public juce::Timer
{
public:
    OpenStudioScriptWindow(const juce::String& title, int width, int height);
    ~OpenStudioScriptWindow() override;
...
private:
    ...
    {
    public:
        Canvas(OpenStudioScriptWindow& owner);
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(OpenStudioScriptWindow)
};
