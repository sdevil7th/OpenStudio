 ...
 */
class JSFXProcessor : public juce::AudioProcessor
{
public:
    JSFXProcessor();
    ~JSFXProcessor() override;
    ...
    // Identify as JSFX (not VST3)
    bool isJSFX() const { return true; }

    // @gfx support — used by JSFXGfxEditor
