...
/**
 * JSFXGfxEditor — JUCE AudioProcessorEditor that renders a JSFX @gfx section.
 *
 ...
 */
class JSFXGfxEditor : public juce::AudioProcessorEditor, public juce::Timer
{
public:
    explicit JSFXGfxEditor(JSFXProcessor& processor);
    ~JSFXGfxEditor() override;
...
private:
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(JSFXGfxEditor)
};
