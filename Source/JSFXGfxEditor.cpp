...
//==============================================================================
JSFXGfxEditor::JSFXGfxEditor(JSFXProcessor& proc)
...
JSFXGfxEditor::~JSFXGfxEditor()
{
    stopTimer();
}

//==============================================================================
void JSFXGfxEditor::paint(juce::Graphics& g)
{
...
void JSFXGfxEditor::updateMouseState(const juce::MouseEvent& e)
{
...
void JSFXGfxEditor::mouseDown(const juce::MouseEvent& e)
{
    updateMouseState(e);
}

void JSFXGfxEditor::mouseDrag(const juce::MouseEvent& e)
{
    updateMouseState(e);
}

void JSFXGfxEditor::mouseUp(const juce::MouseEvent& e)
{
    updateMouseState(e);
}

void JSFXGfxEditor::mouseMove(const juce::MouseEvent& e)
{
    updateMouseState(e);
}

void JSFXGfxEditor::mouseWheelMove(const juce::MouseEvent& e,
...
bool JSFXGfxEditor::keyPressed(const juce::KeyPress& key)
{
    uint32_t mods = 0;
...
bool JSFXGfxEditor::keyStateChanged(bool isKeyDown)
{
...
void JSFXGfxEditor::timerCallback()
{
...
uint32_t JSFXGfxEditor::getYsfxMods(const juce::ModifierKeys& mods) const
{
    uint32_t m = 0;
...
uint32_t JSFXGfxEditor::getYsfxButtons(const juce::ModifierKeys& mods) const
{
    uint32_t b = 0;
...
int32_t JSFXGfxEditor::showMenuCallback(void* userData, const char* menuSpec,
                                          int32_t xpos, int32_t ypos)
{
    auto* editor = static_cast<JSFXGfxEditor*>(userData);
    if (!editor || !menuSpec)
        return 0;
...
void JSFXGfxEditor::setCursorCallback(void* userData, int32_t cursor)
{
    auto* editor = static_cast<JSFXGfxEditor*>(userData);
    if (!editor)
        return;
...
const char* JSFXGfxEditor::getDropFileCallback(void* userData, int32_t index)
{
